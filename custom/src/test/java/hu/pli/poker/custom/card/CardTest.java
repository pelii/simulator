...
public class CardTest {
	...
	for (CardItem cardItem : CardItem.getAllItem()) {
	    ...
	    Card testObj3 = Card.ofCactusCode(cardItem.getCactusValue());
	    assertEquals(testObj.getCardColor(), testObj3.getCardColor());
	    assertEquals(testObj.getCardValue(), testObj3.getCardValue());
	}
    }
